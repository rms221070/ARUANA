...
def test_admin_access():
    ...
    base_url = "https://aruana-vision-1.preview.emergentagent.com/api"
    ...
    admin_data = {
        ...
        "email": f"admin{random_id}@example.com",
    ...
    print(f"User IDs seen by admin: {list(user_ids_in_admin_view)}")
